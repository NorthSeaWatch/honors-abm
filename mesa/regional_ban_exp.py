...
NUM_SHIPS = 300
SHIP_WAIT_TIME = 100
DEFAULT_PORT_POLICY = "allow"         # default for ports not in the custom mapping
SELECTED_PORT = "None"
SELECTED_POLICY = "None"

# New parameter: custom port policies to ban scrubbers on major ports.
# Note: Your ShipPortModel should be updated to parse this parameter.
CUSTOM_PORT_POLICIES = "amsterdam:ban, rotterdam:ban, hamburg:ban, antwerp:ban, london:ban"
...
ax.legend()
fig.savefig("regional_total_scrubber_water_major.png")
plt.close(fig)
...
fig.savefig("regional_relative_revenue_per_port_major.png")
plt.close(fig)
...
ax.legend(loc="upper right")
fig.savefig("regional_relative_docking_frequency_per_port_major.png")
plt.close(fig)